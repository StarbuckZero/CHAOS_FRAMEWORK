...
class CarouselObjectData extends BaseObjectData
{
    /** 
    ...
    **/
    ...
    public function new( displayObj : DisplayObject, defaultIcon : BitmapData = null, selectedIcon : BitmapData = null,  defaultColor : Int = 0, selectedColor = 0, newText : String = "", newVal : String = "")
    {
