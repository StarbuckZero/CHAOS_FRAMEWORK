...
interface ISoundManager
{
    ...
    function crossFade(strFadeOutName : String = "", strFadeInName : String = "", fadeRate : Int = 0, callBack : Dynamic->Void = null) : Bool;
    function fadeTo(strName : String, fadeToNum : Int, fadeRate : Int = -1, callBack : Dynamic->Void = null) : Void;
