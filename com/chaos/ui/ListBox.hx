...
import com.chaos.ui.UIBitmapManager;
	...
	{ 
		...
		public function addItem(item : IBaseSelectData) : Void 
		{ 
			_list.addItem(item);
			draw(); 
		}
		...
		public function removeItem(item : IBaseSelectData) : IBaseSelectData 
		{ 
			var oldItem : IBaseSelectData = _list.removeItem(item);
			draw(); 
		...
		public function removeItemAt(index : Int) : IBaseSelectData { return _list.removeItemAt(index); }
		...
		public function replaceItem(newItem : IBaseSelectData, oldItem : IBaseSelectData) : Void 
		{ 
			draw(); 
		 ...
		 */
		 ...
		 public function replaceItemAt(newItem : IBaseSelectData, index : Int) : IBaseSelectData 
		 { 
			draw();
		 ...
		 *
		 */
		public function getItemAt(value : Int) : IBaseSelectData { return _list.getItemAt(value); } 
		 ...
		 */
		 ...
		 public function getSelected() : IBaseSelectData { return _list.getItemAt(_selectIndex); } 
